.PHONY: info clean-local all build dist
...
info:
	...
	@echo "all, test, run, build, dist, etc"
...
run-server:
	@echo "Run server..."
	@echo "If not present in current folder, run: 'make build_same_dir' and re-run this."
	@./server
